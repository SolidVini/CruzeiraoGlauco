...
public class UsuarioService {
	...
	public List<Usuario> retornaTecnicos(){
		return userDAO.usuariotecnico();
	}
	
	public List<Usuario> retornaPreparador(){
		return userDAO.usuarioPreparador();
	}
	
	public List<Usuario> retornaMassagista(){
		return userDAO.usuarioMassagista();
	}
