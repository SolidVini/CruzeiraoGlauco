...
public class UsuarioManagedBean {
	...
	public List<Usuario> getTecnico(){
		return service.retornaTecnicos();
	}
	
	public List<Usuario> getPreparador(){
		return service.retornaPreparador();
	}
	
	public List<Usuario> getMassagista(){
		return service.retornaMassagista();
	}
