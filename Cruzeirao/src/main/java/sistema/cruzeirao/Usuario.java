...
@NamedQuery(name = "Usuario.pesquisarTecnico", query = "select u from Usuario u where u.role = enums.Roles.TECNICO"),
@NamedQuery(name = "Usuario.pesquisarPreparador", query = "select u from Usuario u where u.role = enums.Roles.PREPARADOR_FISICO"),
@NamedQuery(name = "Usuario.pesquisarMassagista", query = "select u from Usuario u where u.role = enums.Roles.MASSAGISTA")
})
public class Usuario implements Serializable{
	...
	public static final String PESQUISAR_TECNICO = "Usuario.pesquisarTecnico";
	public static final String PESQUISAR_PREPARADOR = "Usuario.pesquisarPreparador";
	public static final String PESQUISAR_MASSAGISTA = "Usuario.pesquisarMassagista";
